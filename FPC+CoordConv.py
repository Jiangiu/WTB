...
class Faster_Block(nn.Module):
    def __init__(self,
        ...
        self.spatial_mixing = PConv(dim,dim)
...
class PRepNCSPELAN4(nn.Module):
    ...
    def __init__(self, c1, c2, c3, c4, c5=1):  # ch_in, ch_out, number, shortcut, groups, expansion
        ...
        self.cv2 = nn.Sequential(RepNCSP(c3 // 2, c4, c5), PConv(c4,c4))
        self.cv3 = nn.Sequential(RepNCSP(c4, c4, c5), PConv(c4,c4))
...
class FPC1(nn.Module):
    # csp-elan
    def __init__(self, c1, c2, c3, c4, c5=1):  # ch_in, ch_out, number, shortcut, groups, expansion
        super().__init__()
        self.c = c3 // 2
        self.cv1 = Conv(c1, c3, 1, 1)
        self.cv2 = RepNCSP(c3 // 2, c4, c5)
        self.cv5 = DWConv(c4,c4)
...
class FPC(nn.Module):
    ...
    def __init__(self, c1, c2, c3, c4, c5=1):  # ch_in, ch_out, number, shortcut, groups, expansion
        ...
        self.c = c3 // 2
        self.cv1 = Conv(c1, c3, 1, 1)
        self.cv2 = nn.Sequential(RepNCSP(c3 // 2, c4, c5), DWConv(c4,c4))
        self.cv3 = Faster_Block(c4)
        self.cv4 = Conv(c3 + (2 * c4), c2, 1, 1)
